...
class Renderer(object):
    def __init__(self, screen):
        ...
        self.camPosition = glm.vec3(0.0, 0.0, 0.0)
        self.camRotation = glm.vec3(0.0, 0.0, 0.0)

        self.projectionMatrix = glm.perspective(glm.radians(60.0), self.width / self.height, 0.1, 1000.0)
    ...
    def getViewMatrix(self):
        ...
        pitch = glm.rotate(identity, glm.radians(self.camRotation.x), glm.vec3(1.0, 0.0, 0.0))
        yaw = glm.rotate(identity, glm.radians(self.camRotation.y), glm.vec3(0.0, 1.0, 0.0))
        roll = glm.rotate(identity, glm.radians(self.camRotation.z), glm.vec3(0.0, 0.0, 1.0))
